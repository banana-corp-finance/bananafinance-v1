import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@bananafinance/sdk'
import { useMemo } from 'react'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import { BUSD, GRIMEX } from '../config/constants/tokens'
...
export const useGrimexBusdPrice = (): Price | undefined => {
  const { chainId } = useActiveWeb3React()
